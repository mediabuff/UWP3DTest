...
void ::NativeApp::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::NativeApp::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 3:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::NativeApp::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::NativeApp::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
